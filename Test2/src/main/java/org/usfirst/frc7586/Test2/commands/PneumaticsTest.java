...
import org.usfirst.frc7586.Test2.subsystems.Pneumatics;
...
public class PneumaticsTest extends Command {
  ...
  protected void execute() {
    Robot.pneumatics.setSolenoid1(Robot.oi.getXboxController());
    Robot.pneumatics.setSolenoid2(Robot.oi.getXboxController());
    Robot.pneumatics.setDoubleSolenoid1(Robot.oi.getXboxController());
  }
